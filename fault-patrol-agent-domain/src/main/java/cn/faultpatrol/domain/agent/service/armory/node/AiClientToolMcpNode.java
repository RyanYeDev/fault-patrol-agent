    ...
    private McpSyncClient createMcpSyncClient(AiClientToolMcpVO aiClientToolMcpVO) {
        ...
        switch (transportType) {
            case "sse" -> {
                ...
                WebClient.Builder webClientBuilder = WebClient.builder().baseUrl(baseUri);
                WebFluxSseClientTransport sseClientTransport = new WebFluxSseClientTransport.Builder(webClientBuilder)
