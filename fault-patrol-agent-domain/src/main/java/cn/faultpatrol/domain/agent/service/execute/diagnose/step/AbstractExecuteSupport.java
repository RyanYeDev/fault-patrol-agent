...
/**
 * 诊断执行节点支撑类：提供对话客户端获取与 SSE 流式输出等公共能力
 */
public abstract class AbstractExecuteSupport extends AbstractStrategyRouter<ExecuteCommandEntity, DefaultDiagnoseAgentExecuteStrategyFactory.DynamicContext, String> {
     ...
     */
    protected void sendSseResult(DefaultDiagnoseAgentExecuteStrategyFactory.DynamicContext dynamicContext,
